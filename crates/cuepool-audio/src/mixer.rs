...
pub struct MixerInput {
    ...
    crosspoints: Mutex<Vec<cuepool_core::Crosspoint>>,
...
impl MixerInput {
    ...
    pub fn set_routing(&self, out_pair: u8, send: f32, crosspoints: Vec<cuepool_core::Crosspoint>) {
...
fn route_cue(
    ...
    dst: &mut [f32],
    n_out: usize,
    crosspoints: &[cuepool_core::Crosspoint],
    out_pair: usize,
    volume: f32,
    pan: f32,
    send: f32,
