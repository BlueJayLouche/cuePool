...
fn dropping_an_idle_driver_returns() {
    ...
    let mut driver =
        MamscDriver::bind(Ipv4Addr::LOCALHOST, rx_port, 7001).expect("bind the released port");
    driver.start(|_pkt, _src| {});
